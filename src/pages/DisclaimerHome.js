  ...
  return (
    <div>
      ...
      <div className="contentContainer">
        ...
        <p>
          Errors and Omissions DisclaimerThe information given by the Service is
          for general guidance on matters of interest only. Even if the Company
          takes every precaution to insure that the content of the Service is
          both current and accurate, errors can occur. Plus, given the changing
          nature of laws, rules and regulations, there may be delays, omissions
        ...
        <p>
          ...
          such copyrighted material as provided for in section 107 of the india
          Copyright law.
        </p>
        <p>
