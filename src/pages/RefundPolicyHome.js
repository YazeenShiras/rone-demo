    ...
    <div>
      ...
      <div className="contentContainer">
        ...
        <p>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to rone
          infotrade pvt ltd, 35/4005/1 3rd floor crown tower sakthan thamburan
          nagar thrissur.
        </p>
        <h5>Goods</h5>
        ...
        <h5>Website</h5>
        <p>
          refers to , accessible from{" "}
          <a href="https://ronedcard.com">ronedcard.com</a>
        </p>
        <h5>You</h5>
        <p>
        ...
        <p>
          The deadline for cancelling an Order 7 14 days from the date on which
        ...
        <p>Product must have the receipt or proof of purchase</p>
        <h5>The following Goods cannot be returned:</h5>
        <p>
